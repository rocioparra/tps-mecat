...
#define SAMPLING_RATE 0.01f // sampling period in seconds (shown as 1 ms)
#define GYRO_MEAS_ERROR_DEG	5.0f
#define GYRO_MEAS_ERROR (PI * (GYRO_MEAS_ERROR_DEG / 180.0f)) // gyroscope measurement error in rad/s (shown as 5 deg/s)
